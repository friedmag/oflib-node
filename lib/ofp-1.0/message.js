...
module.exports = {
            ...
            "unpack" : function(buffer, offset) {
                            ...
                            // Version compatibility means aborting here is not the best idea - just emit the event!
/*                            if (version != ofp.OFP_VERSION) {
                            ...
                            switch (type) {
                                case ofp.ofp_type.OFPT_HELLO: { var unpack = hello.unpack(buffer, offset, len); break; }
                            ...
                            unpack.message.version = version;
